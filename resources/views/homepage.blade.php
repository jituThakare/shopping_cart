          ...
          <div class="p-5"> 
             ...
             <div class="col-md-4 my-4"> 
               <div class="card border text-center">
                  <img src=" {{ asset('storage/'.$product->image ) }} " class="card-img-top" alt="..." style="height: 200px;border-bottom:2px solid #000">
                  <div class="card-body bg-dark text-white"> 
                      <h5 class="card-title"> <a href="single/{{$product->id}}">
                      ...
                      <a href="addToCart/{{ $product->id }}" class="btn btn-primary"><i class="fas fa-cart-plus fa-1x"></i> Add to cart</a>
